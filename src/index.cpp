...
Napi::Object getFeatures(const Napi::CallbackInfo &info) {
    ...
    std::vector<std::string> features = trainTS.getPropertiesRow();
    Napi::Object featuresMap = Napi::Object::New(env);

    int i=0;
    for(std::string feature: features){
        featuresMap.Set(i,feature);
        i++;
    }
    return featuresMap;
...
Napi::Object Init(Napi::Env env, Napi::Object exports) {
    ...
    exports.Set(Napi::String::New(env, "getFeatures"),
                Napi::Function::New(env, getFeatures)
    );
